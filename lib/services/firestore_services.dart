...
//subcategory
  ...
  static getAllOrders()
  {
    return firestore.collection(ordersCollection).where('order_by',isEqualTo: currentUser!.uid).orderBy('order_date', descending: true).snapshots();
  }
